...
namespace MaHoa_AES
{
    ...
    class AES
    {
        ...
        public static String[,] inv_matranbd = {
                                        {"0e","0b","0d","09"},
                                        {"09","0e","0b","0d"},
                                        {"0d","09","0e","0b"},
                                        {"0b","0d","09","0e"}
                                    };
        public static String[] R_con_0 = { "8d", "00", "00", "00" };
        ...
        public static String[] R_con_11 = { "6c", "00", "00", "00" };
        public static String[] R_con_12 = { "d8", "00", "00", "00" };
        public static String[] R_con_13 = { "ab", "00", "00", "00" };
        public static String[] R_con_14 = { "4d", "00", "00", "00" };

        public static int chuyen2sang10(int[] day)
        {
            int kq = 0;
            int viTri = 0;
            for(int i=7; i >= 0; i--)
        ...
        public static int inv_nhanbangbd(String so,String bbd)
        {
            int[] day = new int[8];
            day = cong2day(churanhiphan(so[0]), churanhiphan(so[1]));
            int stateInt = chuyen2sang10(day);
            string kq = "";
            
            if (bbd == "09")
            {
                stateInt = (stateInt << 3) ^ stateInt;
                if (stateInt >= (256 << 2))
                    stateInt = stateInt ^ (0x11b << 2);
                if (stateInt >= (256 << 1))
                    stateInt = stateInt ^ (0x11b << 1);
                if (stateInt >= 256)
                    stateInt = stateInt ^ 0x11b;
                //kq = Convert.ToString(stateInt, 2);
            }
            else if (bbd == "0b")
            {
                stateInt = (stateInt << 3) ^ (stateInt <<1) ^ stateInt;
                if (stateInt >= (256 << 2))
                    stateInt = stateInt ^ (0x11b << 2);
                if (stateInt >= (256 << 1))
                    stateInt = stateInt ^ (0x11b << 1);
            ...
            {
                stateInt = (stateInt << 3) ^ (stateInt << 2) ^ stateInt;
                if (stateInt >= (256 << 2))
                    stateInt = stateInt ^ (0x11b << 2);
                if (stateInt >= (256 << 1))
                    stateInt = stateInt ^ (0x11b << 1);
            ...
            {
                stateInt = (stateInt << 3) ^ (stateInt << 2) ^ (stateInt<<1);
                if (stateInt >= (256 << 2))
                    stateInt = stateInt ^ (0x11b << 2);
                if (stateInt >= (256 << 1))
                    stateInt = stateInt ^ (0x11b << 1);
        ...
        public static int nhanbangbd1(String so, String bbd)
        {
            int[] day = new int[8];
            day = cong2day(churanhiphan(so[0]), churanhiphan(so[1]));
            int dayInt = chuyen2sang10(day);
            String kq = "";
            if (bbd == "01")
            {
                dayInt = dayInt;
        ...
        */
        ...
        public static String XOR16voi4kytu_inv(int so1, int so2, int so3, int so4)
        {
            int kq;
            kq = so1 ^ so2 ^ so3 ^ so4;
            
            return kq.ToString("X2").ToLower();
        }
        ...
        public static String[] bdcotcuoicuakhoa(String[] socot,int i=0)
        {
            String tg;
            tg = socot[0];
            socot[0] = socot[3];
